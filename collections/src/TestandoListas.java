...
// ------------------------------------------
        ...
        System.out.println(a); // sem toString [Aula@2d98a335, Aula@16b98e56, Aula@7ef20235]

        /*
         * Diferente de uma String ou de tipos primitivos mais simples, o Collections.sort não sabe ordenar uma lista de
         * Aula. De qual forma ele faria isso? Pelo nome da aula? Pela duração? Não daria para saber. Para que ele seja
         * capaz de fazer isso, você precisa implementar a interface Comparable definindo um critério de comparação para
         * os objetos desse tipo. Faça com que a classe Aula implemente essa interface e execute a classe
         * TestaListaDeAula para verificar se a ordenação funcionou.
         * */
        Collections.sort(lista); //sort do compareTo da classe Aula
        ...
        // List<Aula> aulaList = curso.getAulas();
        // aulaList.add(new Aula("python", 120));
        // da para escrever dessa forma curso.getAulas().add(new Aula("python", 120));

        //curso.getAulas().add(new Aula("python", 120)); // Exception in thread "main" java.lang.UnsupportedOperationException, devido ter adicionado no getAulas
